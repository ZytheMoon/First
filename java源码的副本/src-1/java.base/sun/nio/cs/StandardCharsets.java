...
public class StandardCharsets extends CharsetProvider {
    ...
    static final String[] aliases_MS950_HKSCS_XP = new String[] {
        "MS950_HKSCS_XP",
    };

    static final String[] aliases_MS950 = new String[] {
        "ms950",
        "windows-950",
    };

    static final String[] aliases_MS874 = new String[] {
        "ms874",
        "ms-874",
        "windows-874",
    };
    ...
    static final String[] aliases_MS936 = new String[] {
        "ms936",
        "ms_936",
    };
    ...
    static final String[] aliases_MS949 = new String[] {
        "ms949",
        "windows949",
        "windows-949",
        "ms_949",
    ...
    static final String[] aliases_MS1255 = new String[] {
        "cp1255",
    };

    static final String[] aliases_MS1256 = new String[] {
        "cp1256",
    };

    static final String[] aliases_MS1258 = new String[] {
        "cp1258",
    };
        ...
        extends sun.util.PreHashedMap<String>
    {
        ...
        private static final int SIZE = 245;
        ...
        extends sun.util.PreHashedMap<String>
    {
        ...
        protected void init(Object[] ht) {
            ...
            ht[1] = new Object[] { "windows-31j", "MS932" };
            ...
            ht[5] = new Object[] { "windows-1255", "MS1255",
                         new Object[] { "windows-1254", "MS1254",
                             new Object[] { "utf-16", "UTF_16" } } };
            ht[6] = new Object[] { "windows-1256", "MS1256",
                         new Object[] { "windows-1257", "MS1257" } };
            ht[7] = new Object[] { "windows-1258", "MS1258",
                         new Object[] { "x-johab", "Johab",
                             new Object[] { "utf-16be", "UTF_16BE" } } };
            ht[8] = new Object[] { "jis_x0201", "JIS_X_0201",
                         new Object[] { "iso-8859-2", "ISO_8859_2",
            ...
            ht[11] = new Object[] { "shift_jis", "SJIS",
                         new Object[] { "x-ibm874", "IBM874",
                             new Object[] { "iso-8859-7", "ISO_8859_7" } } };
            ht[12] = new Object[] { "x-ms950-hkscs-xp", "MS950_HKSCS_XP",
                         new Object[] { "iso-8859-9", "ISO_8859_9" } };
            ht[14] = new Object[] { "x-ibm737", "IBM737" };
            ht[15] = new Object[] { "x-windows-949", "MS949",
            ...
            ht[24] = new Object[] { "x-mswin-936", "MS936",
                         new Object[] { "gbk", "GBK",
                             new Object[] { "x-utf-32be-bom", "UTF_32BE_BOM" } } };
            ht[26] = new Object[] { "x-windows-950", "MS950" };
            ht[27] = new Object[] { "x-windows-874", "MS874" };
        ...
        extends sun.util.PreHashedMap<Charset>
    {
        ...
        protected void init(Object[] ht) {
            ...
            ht[1] = new Object[] { "windows-31j", null };
            ...
            ht[5] = new Object[] { "windows-1255", null,
                         new Object[] { "windows-1254", null,
                             new Object[] { "utf-16", null } } };
            ht[6] = new Object[] { "windows-1256", null,
                         new Object[] { "windows-1257", null } };
            ht[7] = new Object[] { "windows-1258", null,
                         new Object[] { "x-johab", null,
                             new Object[] { "utf-16be", null } } };
            ht[8] = new Object[] { "jis_x0201", null,
                         new Object[] { "iso-8859-2", null,
                             new Object[] { "iso-8859-1", null } } };
            ht[9] = new Object[] { "iso-8859-4", null,
                         new Object[] { "utf-8", null } };
            ht[10] = new Object[] { "iso-8859-5", null };
            ht[11] = new Object[] { "shift_jis", null,
                         new Object[] { "x-ibm874", null,
                             new Object[] { "iso-8859-7", null } } };
            ht[12] = new Object[] { "x-ms950-hkscs-xp", null,
                         new Object[] { "iso-8859-9", null } };
            ht[14] = new Object[] { "x-ibm737", null };
            ht[15] = new Object[] { "x-windows-949", null,
            ...
            ht[24] = new Object[] { "x-mswin-936", null,
                         new Object[] { "gbk", null,
                             new Object[] { "x-utf-32be-bom", null } } };
            ht[26] = new Object[] { "x-windows-950", null };
            ht[27] = new Object[] { "x-windows-874", null };
